...
public class TIFF {
    ...
    public static final int TAG_ImageHeight = 257;
    ...
    public static final int TAG_ForwardTransform1 = 50964;
    public static final int TAG_ForwardTransform2 = 50965;
    ...
    public static final HashMap<Integer,Integer> TYPE_SIZES = new HashMap<>();

    static {
        TYPE_SIZES.put(TYPE_Byte, 1);
        TYPE_SIZES.put(TYPE_String, 1);
        TYPE_SIZES.put(TYPE_UInt_16, 2);
        TYPE_SIZES.put(TYPE_UInt_32, 4);
        TYPE_SIZES.put(TYPE_UFrac, 8);
        TYPE_SIZES.put(TYPE_Undef, 1);
        TYPE_SIZES.put(TYPE_Frac, 8);
        TYPE_SIZES.put(TYPE_Double, 8);
    }
}
