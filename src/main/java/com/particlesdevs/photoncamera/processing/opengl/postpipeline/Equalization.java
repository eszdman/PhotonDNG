...
//
//import android.graphics.GLImage;
//import android.graphics.GLImageFactory;
...
//        glProg.useAssetProgram("analyze",false);
//        File customAnalyzelut = new File(FileManager.sPHOTON_TUNING_DIR,"analyze_lut.png");
//        GLImage analyze_lutbm;
//        GLTexture analyze_lut;
//        if(customAnalyzelut.exists()){
//            analyze_lutbm = GLImageFactory.decodeFile(customAnalyzelut.getAbsolutePath());
//            analyze_lut = new GLTexture(analyze_lutbm,GL_LINEAR,GL_CLAMP_TO_EDGE,0);
//        } else {
//            analyze_lutbm = GLImageFactory.decodeResource(PhotonCamera.getResourcesStatic(),R.drawable.analyze_lut);
//            analyze_lut = new GLTexture(analyze_lutbm,GL_LINEAR,GL_CLAMP_TO_EDGE,0);
//        }
...
//        startT();
//        //GLImage lutbm = GLImageFactory.decodeResource(PhotonCamera.getResourcesStatic(), R.drawable.lut2);
//        int wrongHist = 0;
//        int brokeHist = 0;
